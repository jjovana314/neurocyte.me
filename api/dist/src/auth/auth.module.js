...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([action_entity_1.Action]),
            jwt_1.JwtModule.register({
                secret: config_1.config.get().SECRET_KEY,
                signOptions: { expiresIn: '1h' },
            }),
            user_module_1.UserModule,
        ],
        controllers: [auth_controller_1.AuthController],
        providers: [auth_service_1.AuthService, local_auth_guard_1.LocalAuthGuard, jwt_strategy_1.JwtStrategy],
    })
], AuthModule);
